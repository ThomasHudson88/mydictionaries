...
#datastore only has one key, medical, the value is one big list, see the pink braket for the list, list has 5 dictionaries
datastore = { "medical":[
      { "room-number": 100,
        "use": "reception",
        "sq-ft": 50,
...
for d in datastore["medical"]: #this is for each dictionary in the list of dictionaries
